...
public class netsong extends ListActivity implements Runnable,AdapterView.OnItemClickListener {
...
//                    myAdapter.notifyDataSetChanged();
                    ...
                    ListAdapter adapter = new ArrayAdapter<String>(netsong.this,android.R.layout.simple_list_item_1,listsong);
    ...
    public void run() {
        ...
        try {
            doc = Jsoup.connect("http://music.taihe.com/top/netsong").get();
