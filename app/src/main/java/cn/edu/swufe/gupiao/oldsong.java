...
public class oldsong extends ListActivity implements Runnable,AdapterView.OnItemClickListener{
...
//                    myAdapter.notifyDataSetChanged();
                    ...
                    ListAdapter adapter = new ArrayAdapter<String>(oldsong.this,android.R.layout.simple_list_item_1,listsong);
    ...
    public void run() {
        ...
        try {
            doc = Jsoup.connect("http://music.taihe.com/top/oldsong").get();
